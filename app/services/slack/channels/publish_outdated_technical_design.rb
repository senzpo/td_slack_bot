        ...
        def perform
          ...
          topic = [
            ...
            },
            {
              ...
              text: {
                type: 'mrkdwn',
                text: "Привет Devs Team :wave: \n По вторникам мы проводим online review накопившихся <https://gitlab.taxdome.dev/taxdome/docs/tech-design/-/merge_requests|технических дизайнов>(событие в календаре, вход свободный :slightly_smiling_face:). Мы ожидаем, что будет собран кворум, который позволит принять решение по всем спорным моментам.\n *Задача ревьюверов:* ознакомиться с открытыми дизайнами, подготовить список предложений и замечаний. \n *Задача авторов:* присоединиться к онлайн ревью, закрыть ПР или перевести в черновик."
              }
            },
            {
              type: 'section',
